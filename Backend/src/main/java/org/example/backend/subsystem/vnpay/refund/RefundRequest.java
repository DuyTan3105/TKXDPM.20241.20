package org.example.backend.subsystem.vnpay.refund;


import com.google.gson.Gson;
import com.google.gson.reflect.TypeToken;
import org.example.backend.entities.payment.PaymentTransaction;
import org.example.backend.subsystem.vnpay.VNPayConfig;
...
public class RefundRequest {
    ...
    public String refund() throws IOException {
        ...
        String hash_Data= String.join("|", vnp_RequestId, VNPayConfig.vnp_Version, VNPayConfig.vnp_Command_refund, vnp_TmnCode,
